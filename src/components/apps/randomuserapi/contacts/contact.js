        ...
        <div className="w-100 user-details">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <small class="muted my-0"><i>{user.email}</i></small>
        ...
        <table class="table table-borderless table-sm table-responsive text-light">
            <tbody>
                <DetailsTableRow 
                    _icon="fas fa-user" 
                    _title="Name" 
                    _content={jsUcfirst(user.name.first) + " " + jsUcfirst(user.name.last)}  
                />
                <DetailsTableRow 
                    _icon="far fa-user" 
                    _title="Gender" 
...
function DetailsTableRow(props) {
    return (
        <tr>
            <td className="align-middle text-center"><small><i class={props._icon}></i></small></td>
            <td className="align-middle text-left"><small>{props._title}</small></td>
            <td className="align-middle"><small>:</small></td>
            <td className="align-middle text-left"><small className="muted">{props._content}</small></td>
        </tr>
    );
}
